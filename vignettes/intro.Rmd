...
### Example: Multi-Country Survey Experiment
...
<details>
<summary><font style="font-family: helvetica, arial, freesans, clean, sans-serif; font-size:1.3em; font-weight:bold"> Stratify SPS </font></summary>
This is a test.
```{r}
# This is a test.
```
...
If necessary, users can refine site selection using *stratification* to make sure selected sites satisfy certain conditions. This stratification can help users to incorporate various practical, logistical, and ethical constraints. 
...
### `sps_estimator`: Estimate the Average-Site ATE {#sps_estimator}
...
Here, we use experimental estimates in selected 6 sites from Naumann et al (2018). Users only need to obtain point estimates and standard errors of the average treatment effects (ATEs) in each site. As an example, we use selected sites from `out`. 
